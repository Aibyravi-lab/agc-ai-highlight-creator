    ...
    <nav className="sticky top-0 z-50 bg-[#08090d]/95 backdrop-blur border-b border-[#1a1d2e]">
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <span className="text-xl font-bold tracking-tight">AGC</span>
          <span className="hidden sm:block text-xs text-gray-500">AI Highlight Creator</span>
        </div>

        <div className="hidden md:flex items-center gap-7">
          <a href="#showcase" className="text-sm text-gray-400 hover:text-white transition-colors">Product</a>
          <a href="#features" className="text-sm text-gray-400 hover:text-white transition-colors">Features</a>
          <a href="#how-it-works" className="text-sm text-gray-400 hover:text-white transition-colors">How it Works</a>
          <a href="#faq" className="text-sm text-gray-400 hover:text-white transition-colors">FAQ</a>
          <a href="#beta" className="text-sm text-gray-400 hover:text-white transition-colors">Beta</a>
        </div>
    ...
    <section className="max-w-6xl mx-auto px-6 py-24 md:py-32 flex flex-col md:flex-row items-center gap-16">
      <div className="flex-1 text-center md:text-left">
        ...
        <p className="text-gray-400 text-lg leading-relaxed mb-10 max-w-lg mx-auto md:mx-0">
          Upload your gameplay. Our AI detects the best moments and automatically creates
          highlight reels ready for YouTube Shorts, TikTok and Instagram Reels.
        </p>

        <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
          <Link
            href="/register"
            className="bg-green-600 hover:bg-green-700 text-white font-semibold px-8 py-3.5 rounded-xl text-base transition-colors text-center"
            onClick={() => track("Register Clicked")}
          >
            Start Free Beta
          </Link>
          <Link
            href="/login"
            className="border border-[#1a1d2e] hover:border-[#2a2d3e] text-gray-300 hover:text-white font-medium px-8 py-3.5 rounded-xl text-base transition-colors text-center"
            onClick={() => track("Login Clicked")}
          >
            Login
          </Link>
    ...
    <div className="bg-[#0d0e14] border border-[#1a1d2e] rounded-2xl p-6 shadow-2xl">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-gray-400 font-mono">gameplay_session.mp4</span>
        </div>
    ...
    <section id="showcase" className="bg-[#0a0b10] border-y border-[#1a1d2e] py-20">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-14">
          <h2 className="text-3xl md:text-4xl font-bold mb-3">Built for Streamers</h2>
            ...
            {[
              {
                ...
                desc: "Drop any gameplay file — MP4, MOV, MKV, AVI, or WebM. Any resolution, any length.",
              },
              {
                icon: <IconBolt />,
    ...
    <div className="bg-[#0d0e14] border border-[#1a1d2e] rounded-2xl overflow-hidden shadow-2xl">
      ...
      <div className="bg-[#080910] border-b border-[#1a1d2e] px-4 py-3 flex items-center gap-3">
        ...
        <div className="flex-1 bg-[#1a1d2e] rounded-md px-3 py-1.5 max-w-xs mx-auto">
          <span className="text-xs text-gray-500 font-mono">agc.app/dashboard</span>
        </div>
      </div>
      {/* App layout */}
      <div className="flex" style={{ minHeight: 320 }}>
        ...
        <div className="w-36 border-r border-[#1a1d2e] p-3 flex flex-col gap-1 flex-shrink-0">
          <div className="px-2 py-2 mb-1">
            <span className="text-xs font-bold text-white">AGC</span>
          </div>
          {[
  ...
  return (
    <section className="max-w-6xl mx-auto px-6 py-20">
      <div className="text-center mb-14">
        ...
        <p className="text-gray-400">See exactly what AGC transforms your raw footage into.</p>
      </div>
      ...
      <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
        ...
        <div className="flex-1 bg-[#0d0e14] border border-[#1a1d2e] rounded-2xl p-8 w-full">
          ...
          <h3 className="text-lg font-semibold text-white mb-5">Raw Gameplay</h3>
        ...
        <div className="flex-1 bg-[#0d0e14] border border-green-500/20 rounded-2xl p-8 w-full">
          ...
          <h3 className="text-lg font-semibold text-white mb-5">AGC Output</h3>
          <ul className="space-y-3">
            {[
              "AI Highlight Reel",
  ...
  const steps = [
    {
      ...
      description:
        "Drop your gameplay recording — MP4, MOV, MKV, AVI, or WebM. Any length, any game.",
    },
    {
      number: "02",
  ...
  const steps = [
    {
      icon: <IconUpload />,
      title: "Upload",
      desc: "Drop your gameplay file to start",
    },
    {
      icon: <IconServer />,
      title: "AI Analysis",
  ...
  return (
    <section className="max-w-6xl mx-auto px-6 py-20">
      <div className="text-center mb-14">
        ...
        <p className="text-gray-400">AGC produces three deliverables for every highlight detected.</p>
      </div>
  ...
  const items = [
    {
      ...
      a: "AGC works with any gameplay footage. It analyzes visual intensity and audio peaks rather than game-specific events, so it supports all titles — FPS, MOBA, battle royale, RPG, and more.",
    },
    {
    ...
    },
    {
      ...
      a: "AGC is free during the public beta. Pricing will be announced before the beta ends. Early users who contribute feedback may receive extended free access.",
    },
    {
      q: "What are the beta limitations?",
      a: "During beta, highlight quality may vary across game genres and recording conditions. Processing queues may slow under high server load. Some export formats and platform-specific features are still in active development.",
    },
  ];
  ...
  return (
    <section id="faq" className="max-w-6xl mx-auto px-6 py-20">
      <div className="text-center mb-14">
        ...
        <p className="text-gray-400">Answers to common questions about AGC.</p>
      </div>
      ...
      <div className="max-w-3xl mx-auto space-y-2">
        {items.map((item) => (
          ...
          >
            <summary className="flex items-center justify-between px-6 py-4 cursor-pointer list-none hover:bg-[#1a1d2e]/40 transition-colors">
    ...
    <section id="beta" className="bg-[#0a0b10] border-y border-[#1a1d2e] py-20">
      <div className="max-w-6xl mx-auto px-6">
        <div className="bg-gradient-to-br from-[#0d0e14] to-[#0f1020] border border-[#1a1d2e] rounded-2xl p-10 text-center max-w-2xl mx-auto">
          ...
          <Link
            href="/register"
            className="bg-green-600 hover:bg-green-700 text-white font-semibold px-8 py-3.5 rounded-xl text-base transition-colors inline-block"
            onClick={() => track("Register Clicked")}
          >
            Join the Beta
          </Link>
    ...
    <section className="max-w-6xl mx-auto px-6 py-20">
      <div className="bg-gradient-to-br from-green-900/20 via-[#0d0e14] to-[#0f1020] border border-green-500/20 rounded-3xl px-8 py-16 md:px-16 md:py-20 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/register"
            className="bg-green-600 hover:bg-green-700 text-white font-semibold px-10 py-4 rounded-xl text-base transition-colors"
            onClick={() => track("Register Clicked")}
          >
            Start Free Beta
          </Link>
          <Link
            href="/login"
            className="border border-[#2a2d3e] hover:border-[#3a3d4e] text-gray-300 hover:text-white font-medium px-10 py-4 rounded-xl text-base transition-colors"
            onClick={() => track("Login Clicked")}
          >
            Login
          </Link>
...
function Footer() {
  return (
    <footer className="border-t border-[#1a1d2e] py-10">
      <div className="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <span className="text-sm font-bold tracking-tight">AGC</span>
          <span className="text-gray-600 text-sm">© 2026</span>
          <span className="text-gray-700 text-xs">v0.4.0-beta</span>
        </div>
