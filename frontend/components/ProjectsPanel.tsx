    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="rounded-xl border border-[#1e2030] bg-[#0f1117] p-10 text-center">
          ...
          <p className="text-white font-semibold text-sm">No projects yet</p>
          <p className="text-gray-500 text-sm mt-1.5">
            Once you generate highlights, each video becomes a project you can revisit, download, or share.
          </p>
        </div>
      ) : (
